...
**For the full-stack web development  24/25**
...
3. Run `git clone https://github.com/Mxr1am/eventitude`
4. Once the project has finished downloading, navigate into the projects root directory `cd eventitude`
